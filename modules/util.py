...
def batch_bilinear_sampler(img, coords, mode='bilinear', mask=False, h=256,w=256,mini_batch=4):
    """ Wrapper for grid_sample, uses pixel coordinates """
    ...
    for i in range(num_iter):
        ...
        coords_i = coords[i*mini_batch*h*w:(i+1)*mini_batch*h*w,:,:,:]
...
class ChannelBlock2d(nn.Module):
    ...
    def __init__(self, in_features, kernel_size, padding):
        ...
        self.conv1 = nn.Conv2d(in_channels=in_features, out_channels=in_features//2, kernel_size=kernel_size,
                               padding=padding)
